		...
		<tr>
		  ...
		  %else%
		   ...
		   <td class="oddrowdata-l">
		    <a href="/invoke/wm.sap.Transaction/viewAs?type=xml&amp;$tid=%value $tid%&amp;receiver=%value -urlencode receiver%&amp;msgType=%value -urlencode msgType%">message body as XML</a><br />
		   %ifvar represents equals('idoc')%
		     <a href="/invoke/wm.sap.Transaction/viewAs?type=html&amp;$tid=%value $tid%&amp;receiver=%value -urlencode receiver%&amp;msgType=%value -urlencode msgType%&amp;$sortKey=%value $sortKey%&amp;$dir=%value $dir%">message body as HTML</a><br />
		   %endif%
		     <a href="/invoke/wm.sap.Transaction/viewAs?type=values&amp;$tid=%value $tid%&amp;receiver=%value -urlencode receiver%&amp;msgType=%value -urlencode msgType%">complete pipeline</a>
		   </td>
		  %endif%
		</tr>
		<tr><td class="space" colspan="2">&nbsp;</td></tr>
