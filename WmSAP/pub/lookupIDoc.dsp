<html>
  ...
  <body onLoad="setNavigation('/WmSAP/lookup.dsp', '/WmSAP/doc/OnlineHelp/wwhelp/wwhimpl/js/html/wwhelp.htm?context=Help&topic=IS_LP_IDOC', 'foo');">
    ...
    <table width="100%">
      <tr>
	<td class="menusection-Adapters" colspan="7">Adapters &gt; SAP
	  Adapter &gt; Lookup
	...
	<td>
	  <table class="tableView" width="100%">
	    <thead>
	      <tr>
		<td class="heading" colspan="7">IDoc %value iDocType%%ifvar cimType -notempty%/%value cimType%%endif%%ifvar iDocRelease -notempty%(%value iDocRelease%)%endif% </td>
	      </tr>
	      <tr>
		<td class="subHeading" colspan="7">Top level segments</td>
	      </tr>
	      <tr>
